...
export type Query = {
  __typename?: 'Query',
  fileSource?: Maybe<FileSource>,
  users: Users,
  me?: Maybe<User>,
};


export type QueryFileSourceArgs = {
  sourceId: Scalars['String']
};
...
export type ResolversTypes = {
  ...
  UserKind: UserKind,
  IdPType: IdPType,
  Users: Omit<Users, 'users'> & { users: Array<ResolversTypes['User']> },
  User: User,
  Mutation: {},
...
export type FileSourceResolvers<ContextType = GqlContext, ParentType = ResolversTypes['FileSource']> = {
  ...
  sourceStatus?: Resolver<ResolversTypes['SourceStatus'], ParentType, ContextType>,
...
export type MutationResolvers<ContextType = GqlContext, ParentType = ResolversTypes['Mutation']> = {
  createFileSourceUpload?: Resolver<ResolversTypes['FileSource'], ParentType, ContextType, MutationCreateFileSourceUploadArgs>,
  transcodeFileSource?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, MutationTranscodeFileSourceArgs>,
};

export type QueryResolvers<ContextType = GqlContext, ParentType = ResolversTypes['Query']> = {
  fileSource?: Resolver<Maybe<ResolversTypes['FileSource']>, ParentType, ContextType, QueryFileSourceArgs>,
  users?: Resolver<ResolversTypes['Users'], ParentType, ContextType, QueryUsersArgs>,
  me?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType>,
};

export type SourceBaseResolvers<ContextType = GqlContext, ParentType = ResolversTypes['SourceBase']> = {
...
export type UserResolvers<ContextType = GqlContext, ParentType = ResolversTypes['User']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>,
  ...
  type?: Resolver<ResolversTypes['IdPType'], ParentType, ContextType>,
};

export type UsersResolvers<ContextType = GqlContext, ParentType = ResolversTypes['Users']> = {
